...
constexpr std::string_view SYSFS_GPIO_PATH = "/sys/class/gpio";
constexpr std::string_view SYSFS_GPIO_EXPORT_FN = "/export";
constexpr std::string_view SYSFS_GPIO_UNEXPORT_FN = "/unexport";
constexpr std::string_view SYSFS_GPIO_VALUE = "/value";
constexpr std::string_view SYSFS_GPIO_DIRECTION = "/direction";
constexpr std::string_view SYSFS_GPIO_EDGE = "/edge";
...
constexpr std::string_view EDGE_RISING = "rising";
constexpr std::string_view EDGE_FALLING = "falling";
