// Terminal6x8e.h – minimal 6x8 terminal font
// Characters from ASCII 32 (space) to 255
// Each character = 6 columns of 8 bits
#pragma once
#include <stdint.h>

// Subset: printable ASCII 32..127 only, rest zeros
// This is a compact 6x8 font data table
// Rows are characters (0-based from space = char-32), cols are pixel columns
