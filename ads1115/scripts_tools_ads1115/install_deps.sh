#!/bin/bash
# Instalador de dependencias para ads1115 (ADC ADS1115 por I2C)
# Uso: sudo bash scripts/install_deps.sh

set -e

echo "============================================"
echo "  Instalando dependencias para ads1115"
echo "============================================"

sudo apt update
sudo apt install -y build-essential wiringpi libwiringpi-dev
