...
void sound_init() {
    ...
    //    fprintf(stderr, "Sound: ERROR al solicitar GPIO %d\n", PIN_SOUND);
   }
    // ...
//}
}
...
void sound_stop()   {}
void sound_bird()   { gpio_beep(1200, 50); delay_ms(30); gpio_beep(1000, 50); }


void sound_start() {
    sound_beep(660, 100); delay_ms(50);
    sound_beep(880, 100); delay_ms(50);
    sound_beep(1100, 150); delay_ms(100);
    sound_beep(880, 100); delay_ms(50);
    sound_beep(1320, 200);
}
