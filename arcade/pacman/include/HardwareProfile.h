...
#define PIN_DC     25   // D/C        (pin físico 22)
#define PIN_RST    24   // RESET      (pin físico 18)
#define PIN_BL     23   // Backlight  (pin físico 16)
#define PIN_SOUND  12   // Buzzer     (pin físico 32)
